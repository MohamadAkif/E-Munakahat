...
<div class="title">
    ...
    <div class="alert alert-primary">
        ANDA TIDAK BOLEH MEMOHON SEKIRANYA BELUM DAFTAR PERKAHWINAN <a class="alert-link"></a>  </div>
        <?php endif; ?>
...
<form action="ViewApplicationInformation.php" method="GET">
    ...
    <td><a href="ViewApplicationInformation.php?applicant_ic=<?php echo $this->applicant['applicant_ic'] ?> ">SEMAK</a></td>
    </tr>
    <?php endif; ?>
</table>
...
$form = new NewApplicationPage($facade);
$form->searchIC();
$form->renderForm();
